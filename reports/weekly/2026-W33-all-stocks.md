# Weekly Report — `all-stocks` — 2026-W33

Generated: 2026-08-16  ·  Source: `apewisdom:all-stocks`  ·  Lookback: 7 days
...
| DTE | +1.85% | +0.290 | -0.190 | +0.545 | -0.228 | +0.076 | 0.145 | 406 | Value tilt; Modest factor fit |
...
|--------|-----------|----------|--------|--------|------|-------|----------|----------|---|
| ONDS | **83.33** | 23.33 | 26.67 | 33.33 | 0.299 | +1.051 | 1.3029 | 0.0684 | 156 |
| SNDK | **80.00** | 16.67 | 33.33 | 30.00 | 0.316 | +2.187 | 1.0973 | 0.0576 | 156 |
| NBIS | **76.67** | 20.00 | 30.00 | 26.67 | 0.316 | +1.175 | 1.0929 | 0.0574 | 156 |
| HTZ | **66.67** | 30.00 | 13.33 | 23.33 | 0.119 | +0.090 | 0.8662 | 0.0455 | 156 |
| DTE | **46.67** | 33.33 | 10.00 | 3.33 | 0.061 | +0.038 | 0.1787 | 0.0094 | 156 |
| RDDT | **43.33** | 26.67 | 3.33 | 13.33 | 0.256 | -0.705 | 0.6640 | 0.0349 | 156 |
| RKLB | **43.33** | 6.67 | 16.67 | 20.00 | 0.434 | +0.434 | 0.8095 | 0.0425 | 156 |
| MU | **43.33** | 10.00 | 23.33 | 10.00 | 0.334 | +0.720 | 0.6451 | 0.0339 | 156 |
| SMCI | **36.67** | 13.33 | 6.67 | 16.67 | 0.328 | -0.045 | 0.7484 | 0.0393 | 156 |
| NVDA | **30.00** | 3.33 | 20.00 | 6.67 | 0.671 | +0.587 | 0.2446 | 0.0128 | 156 |
...
- Period: `2024-08-16` to `2026-03-31` (406 obs)
- R² = 0.1453 (adjusted = 0.1346)
- Alpha (annualized): **+1.85%** (daily = +0.000073, t = +0.15, p = 0.8826)

Factor loadings:

| Factor | β | t-stat | p-value |
|--------|---|--------|---------|
| Mkt-RF | +0.2898 | +5.47 | 0.0000 *** |
| SMB | -0.1895 | -2.11 | 0.0353 * |
| HML | +0.5450 | +6.71 | 0.0000 *** |
| RMW | -0.2275 | -2.27 | 0.0235 * |
| CMA | +0.0756 | +0.72 | 0.4726  |
