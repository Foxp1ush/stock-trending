# Weekly FF5 Factor Report — 2026-W21

Generated: 2026-05-22

## Selection

- Top 10 tickers by accumulated mentions on ApeWisdom `apewisdom:all-stocks` over the last 7 days.
...
- Factor data: Kenneth R. French Data Library (F-F_Research_Data_5_Factors_2x3_daily).
- Price data: Yahoo Finance via yfinance (auto-adjusted close).

### Disclaimer

_This report is generated for research and educational purposes only. It is not investment advice. Past performance does not predict future returns. Statistical significance does not imply economic significance._